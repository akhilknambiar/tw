...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>True Ways Cargo Transports L.L.C - Transportation & Cargo Services</title>
...
Near Dubai Cargo Village, Dubai, U.A.E
            ...
            <div class="top-text">
                <small class="txt-sky-blue">Email Us</small>
                <a href="mailto:sales@truewayslogistics.com">sales@truewayslogistics.com</a>
            </div>
            <div class="top-text">
          ...
          <div class="col-md-auto">
            ...
            <div class="d-inline-flex request-btn ml-2">
                <a class="btn-theme icon-left bg-orange no-shadow d-none d-lg-inline-block align-self-center" href="#" role="button" data-toggle="modal" data-target="#request_popup"><i class="icofont-page"></i> Request Quote</a>
            </div>         
          </div>
        </div>
      </div>
        ...
        <ul>
          ...
          >
            ...
            <li data-index="rs-3045" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0"
                ...
                <!-- MAIN IMAGE -->
                <img src="images/banner_slider_3.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                ...
                <div class="tp-caption NotGeneric-Title tp-resizeme"
                     ...
                     data-splitout="none"
                     data-responsive_offset="on"
                     style="z-index: 2; white-space: nowrap; font-size: 18px; line-height: 30px;">
                    <!--                slide 2 text-->
                </div>
  ...
  <main id="body-content">
    ...
    <section class="bg-light-gray wide-tb-100 bg-wave">
      <div class="container pos-rel">
        <div class="row">
          <div class="col-md-6">
            <img src="images/about_img_2.jpg" class="bordered-img" alt="">
          </div>
          
          <div class="col-md-6 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
              <!-- Heading Main -->
              <h1 class="heading-main text-left wow fadeInDown" data-wow-delay="0s" data-wow-duration="0">
                  <span>Welcome To</span>
                  True Ways Cargo Transports L.L.C
              </h1>
              <!-- Heading Main -->

              <p>Trueways is a holistic Logistics Service-Provider offering on-demand in-land Transportation solutions
                  catering to various consignment movement in both full-load, part-load and bulk shipments with a
                  promise to deliver our commitments on time. We cater to multiple destinations within the United Arab
                  Emirates (Dubai, Abu Dhabi, Sharjah, Ajman, Ras Al Khaimah, Umm Al Quwain and Fujairah) offering
                  seamless end to end transportation solutions.
              </p>
              <br/><br/>
              <h3 class="heading-main text-center"><span>Mission, Vision and Values</span>
                  “Delivery simplified each way diligently”</h3>
                  ...
                  <div class="icon-box-3 mb-5 bg-sky-blue">
                    <div class="media">
                        <div class="service-inner-content media-body"><br><br>
                            <h4 class="h4-md"><i class="icofont-shield"></i> Our team consider the customer first in everything we do with focus on customer-satisfaction. </h4> <br>
                            <h4 class="h4-md"><i class="icofont-shield"></i> Ideal combination of carrier and service enhancements to ensure fast, safe and timely delivery.</h4>  <br>
                            <h4 class="h4-md"><i class="icofont-shield"></i> Meticulously planned freight forwarding services to save time and cost for your cargo.</h4>  <br>
                            <h4 class="h4-md"><i class="icofont-shield"></i> Interactive, real time and user-friendly web and app interface to track your shipment at any point of time.</h4>  <br>
                            <h4 class="h4-md"><i class="icofont-shield"></i> Meticulously planned freight forwarding services to save time and cost for your cargo.</h4>   <br>
                        </div>
                    </div>
                  </div>              
